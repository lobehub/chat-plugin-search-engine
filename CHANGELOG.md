...
## [Version 1.6.0](https://github.com/lobehub/chat-plugin-search-engine/compare/v1.5.0...v1.6.0)
...
- **misc**: Add plugin meta in manifest.json ([8e822d8](https://github.com/lobehub/chat-plugin-search-engine/commit/8e822d8))
...
- **misc**: Fix a compatible error with nginx header ([eb18fbc](https://github.com/lobehub/chat-plugin-search-engine/commit/eb18fbc))
...
- **misc**: 增加 hoverable 卡片样式 ([946794e](https://github.com/lobehub/chat-plugin-search-engine/commit/946794e))
...
- **misc**: 兼容移动端 ([6389232](https://github.com/lobehub/chat-plugin-search-engine/commit/6389232))
